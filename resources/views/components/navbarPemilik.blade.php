<nav class="flex items-center justify-between bg-drago text-white p-4">
    ...
    <ul class="flex gap-6 text-lg font-semibold">
        <li><a href="" class="{{ request()->routeIs('DashboardPemilik') ? 'text-[#0cbd66]' : 'hover:text-[#0cbd66]' }}">Home</a></li>
        ...
        <li><a href="" class="{{ request()->routeIs('halPetani') ? 'text-[#0cbd66]' : 'hover:text-[#0cbd66]' }}">Petani</a></li>
