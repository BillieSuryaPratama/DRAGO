<nav class="flex items-center justify-between bg-drago text-white p-4">
    ...
    <ul class="flex gap-6 text-lg font-semibold">
        ...
        <li><a href="{{ route('showHalPenjadwalan') }}" class="{{ request()->routeIs(['showHalPenjadwalan', 'showHalTambahJadwalKegiatan', 'showHalDetailKegiatan', 'showHalUbahKegiatan']) ? 'text-[#0cbd66]' : 'hover:text-[#0cbd66]' }}">Penjadwalan</a></li>
