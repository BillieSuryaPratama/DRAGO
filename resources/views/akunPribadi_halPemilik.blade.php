...
<head>
    <meta charset="UTF-8">
    <title>Akun Pribadi - DRAGO</title>
            ...
            <div class="flex justify-between items-start">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-lg">{{ $akun->Username}}</p>
                    </div>
                </div>
                <a href="{{ route('editAkun') }}" class="{{ request()->is('editAkun') ? 'bg-blue-500 text-white px-4 py-1 rounded hover:bg-blue-600' : 'bg-blue-500 text-white px-4 py-1 rounded hover:bg-blue-600' }}">Edit</a>
            </div>
