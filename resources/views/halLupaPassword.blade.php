    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-1/2 bg-white flex flex-col items-center justify-center p-10">
            @if ($mode === 'Lupa Password')
                ...
                <form method="POST" action="{{ route('ubahPassword') }}" class="w-full max-w-sm space-y-4">
                    @csrf
                    <div>
                    ...
                    <div>
                        ...
                        <input type="password" id="konfirmasi_password" name="konfirmasi_password" class="w-full border border-green-500 rounded px-3 py-2">
                    </div>
