...
<main class="p-6 bg-white rounded-b-xl">
    <form action="{{ route('Simpan') }}" method="POST" class="max-w-5xl mx-auto mt-6">
        @csrf
        ...
        <div class="bg-white shadow-md rounded-lg p-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="password" name="Sandi" value="{{ old('Sandi') }}" class="w-full border border-pink-600 rounded px-3 py-2 mt-1">
                </div>
            </div>
