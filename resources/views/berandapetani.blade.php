...
<body class="font-urbanist bg-gray-100 min-h-screen">
    ...
    <nav class="flex items-center justify-between bg-drago text-white p-4">
        ...
        <div class="flex gap-6 text-lg font-semibold">
            <a href="{{ route('berandapetani') }}" class="nav-link hover:underline {{ request()->is('berandapetani') ? 'text-green-800' : 'text-white' }}">
                Home
            </a>
            <a href="{{ route('deteksi') }}" class="nav-link hover:underline {{ request()->is('deteksi') ? 'text-green-800' : 'text-white' }}">
                Deteksi
            </a>
            ...
            <a href="{{ route('akunpetani') }}" class="nav-link hover:underline {{ request()->is('akunpetani') ? 'text-green-800' : 'text-white' }}">
                Akun
            </a>
        </div>
    </nav>
