...
<body class="font-urbanist bg-gray-100 min-h-screen">
    ...
    <nav class="flex items-center justify-between bg-drago text-white p-4">
        ...
        <div class="flex gap-6 text-lg font-semibold">
            ...
            <a href="{{ route('penjadwalan') }}" class="hover:underline {{ request()->is('penjadwalan') ? 'text-green-800' : 'text-white' }}">Penjadwalan</a>
            <a href="{{ route('laporan') }}" class="hover:underline {{ request()->is('laporan') ? 'text-green-800' : 'text-white' }}">Laporan</a>
            <a href="{{ route('akun') }}" class="hover:underline {{ request()->is('akun') ? 'text-green-800' : 'text-white' }}">Akun</a>
        </div>
    </nav>
